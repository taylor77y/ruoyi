...
public class TMember extends BaseEntity
{
    ...
    private String welMemberUuid;

    public String getWelMemberUuid() {
        return welMemberUuid;
    }

    public void setWelMemberUuid(String welMemberUuid) {
        this.welMemberUuid = welMemberUuid;
    }

    private String welMemberPhone;

    public String getWelMemberPhone() {
        return welMemberPhone;
    }

    public void setWelMemberPhone(String welMemberPhone) {
        this.welMemberPhone = welMemberPhone;
    }
