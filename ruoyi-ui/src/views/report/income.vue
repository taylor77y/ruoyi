...
export default {
  ...
  methods: {
    /** 查询会员列表 */
    getList() {
      getIncomeData(this.queryParams).then(response => {
    ...
    submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            if(this.ruleForm.info != null){
              this.queryParams.openTime = this.ruleForm.info[0];
              this.queryParams.closeTime = this.ruleForm.info[1];
            }
            this.getList();
          }
        });
      ...
      resetForm(formName) {
        ...
        this.queryParams.openTime = null;
        this.queryParams.closeTime = null;
        this.getList();
      }
  }
};
