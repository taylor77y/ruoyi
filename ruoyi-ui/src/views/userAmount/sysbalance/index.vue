<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="排序类型" prop="orderByColumn">
        <el-select v-model="queryParams.orderByColumn" placeholder="请选择排序类型" clearable>
          <el-option
            v-for="dict in dict.type.balance_order"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <!-- <el-form-item label="冻结余额" prop="blockedBalance">
        <el-input
          v-model="queryParams.blockedBalance"
          placeholder="请输入冻结余额"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="资产冻结" prop="assetsBlockedBalance">
        <el-input
          v-model="queryParams.assetsBlockedBalance"
          placeholder="请输入资产冻结"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="充提可用" prop="assetsBalance">
        <el-input
          v-model="queryParams.assetsBalance"
          placeholder="请输入充提可用"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="合约可用" prop="tokenBalance">
        <el-input
          v-model="queryParams.tokenBalance"
          placeholder="请输入合约可用"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="合约冻结" prop="tokenBlockedBalance">
        <el-input
          v-model="queryParams.tokenBlockedBalance"
          placeholder="请输入合约冻结"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="法币冻结" prop="fbBlockedBalance">
        <el-input
          v-model="queryParams.fbBlockedBalance"
          placeholder="请输入法币冻结"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="私募冻结" prop="raiseBalance">
        <el-input
          v-model="queryParams.raiseBalance"
          placeholder="请输入私募冻结"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="恋上资产" prop="chainBalance">
        <el-input
          v-model="queryParams.chainBalance"
          placeholder="请输入恋上资产"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="balanceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="资产冻结" align="center" prop="assetsBlockedBalance" />
      <el-table-column label="充提可用" align="center" prop="assetsBalance" />
...
<script>
import { listBalance, getBalance, delBalance, addBalance, updateBalance } from "@/api/system/sysbalance";

export default {
  name: "Balance",
  dicts:['balance_order','t_user_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
